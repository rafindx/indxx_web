...
class DbUtils extends mysqli {
    ...
    public function __construct() {
        $this->conn = mysqli_connect("localhost", "indxx_uat", "Ov7y0i0@Pf$3", "indexl_work_uat");


	    $result = mysqli_query($this->conn,"select `id` from `indxx` where  productlist=1 and weighttype=1 order by id desc");
