...
$classpr='';
                                       ...
                                       //echo $indxx_details[0]->return_type."<br/>";
                                        //echo $trIndexId;
                                        ?>
                                         ...
                                         if($trIndexId>0) { ?>   <a class="<?php echo $classtr ; ?>" href="<?php echo base_url($uri[3].'/'.$uri[4].'/'.$this->indice->getSlugByIndxxId($trIndexId)); //site_url($this->indice->getSlugByIndxxId($trIndexId)) ?>" id="type_diff">TR</a> <?php } 
                                        
                                         ?>

                                       <?php if($PrIndexId>0) { ?>   <a class="<?php echo $classpr ; ?>" href="<?php echo  base_url($uri[3].'/'.$uri[4].'/'.$this->indice->getSlugByIndxxId($PrIndexId)); //site_url($this->indice->getSlugByIndxxId($PrIndexId)) ?>" id="type_diff">PR</a> <?php } ?>

                                       <?php if($NTRIndexId>0) { ?> <a class="<?php echo $classntr ; ?>" href="<?php echo base_url($uri[3].'/'.$uri[4].'/'.$this->indice->getSlugByIndxxId($NTRIndexId)); // site_url($this->indice->getSlugByIndxxId($NTRIndexId)) ?>" id="type_diff">NTR</a> <?php } ?>
                                     
                                       <?php if($cadgtrIndexId>0) { ?> <a class="<?php echo $classgtr ; ?>"  href="<?php echo base_url($uri[3].'/'.$uri[4].'/'.$this->indice->getSlugByIndxxId($cadgtrIndexId)); // site_url($this->indice->getSlugByIndxxId($cadgtrIndexId)) ?>" id="type_diff">CAD GTR</a> <?php } ?>
                                       <?php if($cadntrIndexId>0) { ?> <a class="<?php echo $classcntr ; ?>"  href="<?php echo base_url($uri[3].'/'.$uri[4].'/'.$this->indice->getSlugByIndxxId($cadntrIndexId)); // site_url($this->indice->getSlugByIndxxId($cadntrIndexId)) ?>" id="type_diff">CAD NTR</a> <?php }?>
   ...
   <div class="charting">
                          ...
                          ?>
                                ...
                                <div id="no-more-tables " style="">
                                    <?php if($indxxID==323 || $indxxID==324 || $indxxID==325 || $indxxID==362 || $indxxID==252 || $indxxID==766 || $indxxID==894|| $indxxID==692 || $indxxID==691 || $indxxID==693 
                                    ...
                                    || $indxxID==720 || $indxxID==718 || $indxxID==722 || $indxxID==241 || $indxxID==759 || $indxxID==835 || $indxxID==836 
                                    || $indxxID==837){?>
                                    ...
                                    <?php if($indxxID==692 || $indxxID==691 || $indxxID==693 || $indxxID==694 || $indxxID==695 || $indxxID==696 || $indxxID==697 || $indxxID==698 || $indxxID==699 || $indxxID==700 
                                          ...
                                          || $indxxID==713 || $indxxID==714 || $indxxID==715 || $indxxID==721 || $indxxID==720 || $indxxID==718 || $indxxID==722 || $indxxID==835 || $indxxID==836 || $indxxID==837){ 
                                    $date_check = date('d');
                                    $currentMonth = date('F');
                                    ...
                                    ?>
                                    <div style="font-size:10px; margin-bottom:2px; margin-top:15px;"><sup style="font-size:9px;text-align:left;">*</sup> As of 03rd Jan 2022 open.</div>
                                    <?php } ?>
                                </div>
                          <?php  } ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="height:30px;font-size: 13px;background:none repeat scroll 0 0 #ccc;">
                                               ...
                                               <?php if($base > $threemonth) { ?>
                                                ...
                                                <td align="right" nowrap="nowrap">NA</td>
                                                <?php }else{ ?>
                                                <td align="right" nowrap="nowrap"><?php if($indxx_details[0]->return_type=='CADGTR' || $indxx_details[0]->return_type=='CADNTR' || $indxx_info->code=='IISERI' || $indxx_info->code=='IISERIP' || $indxx_info->code=='IISERINT'){echo 'NA';} elseif($IndexRiskReturnsArray['Beta']['ytd']!=0) { echo (number_format($IndexRiskReturnsArray['Beta']['ytd'], 2, '.', '')); } else { echo 'NA2'; }?></td>
                                                 <?php  } ?> 
                                                <?php if($baseTimeStamp > $oneYearTimeStamp && $base > $oneYear) {?>
                                                <td align="right" nowrap="nowrap">NA</td>
                                                <?php }else{ ?>
...
console.log(chartData2);
        var chart = AmCharts.makeChart("chartContainer", {
            ...
            "dataSets": [{
                    ...
                    "title": "Benchmark: Indxx 500 Index (INXP)",
                    <?php } if($indxx_details[0]->return_type=='TR') { ?>
                    "title": "Benchmark: Indxx 500 Index (INXT)",
                    <?php } if($indxx_details[0]->return_type=='NTR'){ ?>
                    "title": "Benchmark: Indxx 500 Index (INXTNT)",
                    <?php } }?>
