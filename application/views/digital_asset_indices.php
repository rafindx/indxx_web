...
<title>Digital Asset Indices - Indxx </title>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="solution_tabs">
						...
						<ul>
                                ...
                                <li role="presentation" class="active"><a href="<? echo base_url()?>indices/digital_asset" class="str"><i class="fa fa-sitemap" aria-hidden="true"></i> Digital Asset Indices</a></li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
					...
					<div class="agileits_about_grids w3ls_products_grid">
                            ...
                            <div id="digital" aria-labelledby="digital-tab">
										<h3>Digital Asset Indices</h3>
										<p>Indxx Digital Asset Indices are designed to effectively target and represent the performance of the leading crypto tokens that are trading on open exchanges. <br/><br/>
                                        Our Indices serve as effective tools to gauge the volatility and movement of the rapidly growing global cryptocurrency markets or a selection of cryptocurrencies, such as Bitcoin, Ethereum, Ripple and more. <br/><br/>
                                        Looking to build cryptocurrency indices? Contact us at <a href="mailto:info@indxx.com" >info@indxx.com</a>.
										...
										<ul class="list3">
											...
											?>  
										<li><a href="<?php echo site_url('indices/digital_asset/'.$digital->slug) ?>" rel="nofollow" ><?php echo $digital->indxx_name;?></a></li>
