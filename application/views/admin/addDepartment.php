        ...
        <section class="content">
            <div class="row">
                <div class="box box-primary" style="margin: 4% 0 0 23%; width: 50%">
                    ...
                    <form role="form" method="post" action="<?php echo base_url('index.php/admin/addDepartment') ?>" enctype="multipart/form-data" >

                        <div class="box-body" style="border:none!important;">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Department Name</label>
                                <input class="form-control" type="text" 
                                       name="department_name" value="" required="required">
