    ...
    <div class="content-wrapper">
        <section class="content-header">  
            <ol class="breadcrumb">
                ...
                <li class="active">Add Management</li>
            </ol>
        </section>
        <div class="row">
            <div class="col-md-10">
            ...
            <div class="row">
                <div class="box box-primary" style="margin: 4% 0 0 23%; width: 50%">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Management</h3>
                    </div>        
                    <form role="form" method="post" action="<?php echo base_url('index.php/admin/addManagement') ?>" enctype="multipart/form-data" >
                        ...
                        <div class="box-body" style="border:none!important;">
                            ...
                            <div class="form-group">
                                ...
                                <input required="required" class="form-control" type="text" name="designation" value="">
                                <?php echo form_error('designation'); ?>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">About</label>
                                <textarea class="form-group textarea" name="about" required="required"></textarea> 
