...
$classpr='';
   ...
   <div class="charting">
                          ...
                          ?>
                                ...
                                <?php if($indxx_info->is_all==1 && ($indxxID==862 || $indxxID==905 || $indxxID==898 || $indxxID==899 || $indxxID==900)) { ?>
                                    <h2 class="ttle" style="">Index Constituents</h2>
                                <?php }
                                else if($indxxID==862 || $indxxID==905 || $indxxID==898 || $indxxID==899 || $indxxID==900) { ?>
                                ...
                                <div id="no-more-tables " style="">
                                    ...
                                    || $indxxID==720 || $indxxID==718 || $indxxID==722 || $indxxID==350 || $indxxID==862 || $indxxID==905 || $indxxID==898
                                    || $indxxID==899 || $indxxID==900){
                                    ...
                                    <table id="example" class="col-md-12 table-bordered table-striped table-condensed cf" style="margin-top:24px; width:100%;">
                                        <?php }
                                        if($indxxID==862 || $indxxID==905 || $indxxID==898 || $indxxID==899 || $indxxID==900){ ?>
                                        <thead class="cf">
                                            <tr> 
                                        ...
                                        <tbody>
                                          ...
                                          // print_r($indxx_info->is_all);
                                            if($indxx_info->is_all==0 && ($indxxID==862 ||  $indxxID==905 || $indxxID==898 || $indxxID==899 || $indxxID==900))	
                                            {	
                                           ...
                                           else if($indxxID==905 || $indxxID==862 || $indxxID==898 || $indxxID==899 || $indxxID==900) { //print_r($IndexTopFiveConstituentsArray);
                                           foreach ($IndexTopFiveConstituentsArray as $topCond) { ?>
                                                <tr>
                                                    <!--<td style="width:33%;" data-title="Ticker"<?php if($indxx_info->is_isin==0){ ?> style="display: none;" <?php } ?>> <?php echo $topCond["ISIN"]; ?></td>-->
                                                    <td style="width:33%;" data-title="Company Name" <?php if($indxx_info->is_company_name==0){ ?> style="display: none;" <?php } ?>> <?php echo ucwords(strtolower($topCond["constituent"])); ?></td>
