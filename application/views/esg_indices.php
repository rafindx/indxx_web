...
<title>ESG Indices - Indxx </title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="ESG Indices, ESG Index, ESG Indexes, ESG Investing, ESG Leaders Indexes, ESG Focus Indexes, Environmental Index, Green Index, Governance Index, Social Index">
<meta name="description" content="Indxx ESG Indices utilize Environment, Social and Governance (‘ESG’) ratings provided by Institutional Shareholder Services (‘ISS ESG’) and offer a range of ESG indices to help investors meet their sustainable investing goals.">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="solution_tabs">
						...
						<ul>
							    ...
							    <li role="presentation" class="active"><a href="<? echo base_url()?>indices/esg" class="str"><i class="fa fa-envira" aria-hidden="true"></i> ESG Indices</a></li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
					...
					<div class="agileits_about_grids w3ls_products_grid">
							...
							<div id="esg" aria-labelledby="esg-tab">
										<h3>ESG Indices</h3>
										<p>Indxx ESG Indices utilize Environment, Social and Governance (‘ESG’) ratings provided by Institutional Shareholder Services (‘ISS ESG’) and offer a range of ESG indices to help investors meet their sustainable investing goals.<br/><br/>
                                            Indxx’s indexing expertise, combined with innovative and high quality ESG ratings, translates into a suite of unique ESG products with global coverage. From proprietary ESG indices developed in-house, to customised ESG indices and ESG model development, our ESG capabilities cater to a broad range of requirements. <br/><br/>
                                            Our indices are designed to serve as effective tools to integrate ESG ratings (Corporate Ratings, Governance Quality Score, Carbon Risk Ratings, Climate Solutions, UN SDG, OECD, etc.) into investment portfolios. Our experienced product team works closely with clients to understand their core objective and build indices that best capture the value proposition.<br/><br/> 
                                            Need support with ESG solutions? Write to us at <a href="mailto:info@indxx.com" >info@indxx.com</a>.<br/><br/>
										...
										<ul class="list3">
											...
											?>  
										<li><a href="<?php  echo site_url('indices/esg/'.$esg->slug) ?>" rel="nofollow" ><?php echo $esg->indxx_name;?></a></li>
