...
if(!$urr[1]){
    ...
    $slug=$indxx_details[0]->slug;
    if($cat=='Benchmark' || $cat=='ESG' || $cat=='Income' || $cat=='Strategy' || $cat=='Thematic'){
       $redi_url = base_url()."indices/".strtolower($cat)."/".$slug;
        header("Location: $redi_url");
    }
    else if($cat=='Other Indices'){
        $redi_url = base_url()."indices/other/".$slug;
        header("Location: $redi_url");
    }
    else if($cat=='Digital Asset'){
        $redi_url = base_url()."indices/digital_asset/".$slug;
        header("Location: $redi_url");
    }
}
   ...
   <div class="charting">
                          ...
                          ?>
                                ...
                                <div id="no-more-tables " style="">
                                    ...
                                    || $indxxID==720 || $indxxID==718 || $indxxID==722){?>
