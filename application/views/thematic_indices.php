...
<title>Thematic Indices - Indxx</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="Thematic Indices, Thematic Index, Thematic Indexing, Thematic Indexes, Thematic Investing, Thematic Investment">
<meta name="description" content="Indxx Thematic Indices capture the performance of broad investment themes ranging from demographic trends to emerging technologies and social themes. Our Thematic Indices target long-term growth strategies that are expected to benefit from assimilation of these emerging trends into market dynamics.">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="solution_tabs">
						...
						<ul>
								...
								<li role="presentation" class="active"><a href="<? echo base_url()?>indices/thematic" class="str"><i class="fa fa-sitemap" aria-hidden="true"></i>Thematic Indices</a></li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
					...
					<div class="agileits_about_grids w3ls_products_grid">
							...
							<div  id="thematic" aria-labelledby="thematic-tab">
										<h3>Thematic Indices</h3>
										<p>Indxx Thematic Indices capture the performance of broad investment themes ranging from demographic trends to emerging technologies and social themes.<br/><br/>
										We undertake intensive research of the global investing landscape to identify megatrends/themes across the macroeconomic, technology, demographic and geopolitical spheres. These broad themes are further deconstructed into multiple granular sub-themes. Our indices utilise a systematic framework to determine leading companies that function across any of the sub-themes. The research focused development pedagogy translates into a suite of flexible innovative solutions that effectively capture disruptive investment themes.<br/><br/>
                                        Our Thematic Indices  target long-term growth strategies that are expected to benefit from assimilation of these emerging trends into market dynamics. <br/><br/>
                                        Want support in meeting your thematic investing goals? Contact us at <a href="mailto:info@indxx.com" >info@indxx.com</a>.
										</p>
...
//  usort($get_thematic, 'sortByName'); print_r($get_thematic);
											...
											?>  
										<li><a href="<?php echo site_url('indices/thematic/'.$thematic->slug) ?>" rel="nofollow" ><?php echo $thematic->indxx_name;?></a></li>
