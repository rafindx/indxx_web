...
<title>Other Indices - Indxx</title>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="solution_tabs">
						...
						<ul>
								...
								<li role="presentation" class="active"><a href="<? echo base_url()?>indices/other" class="str"><i class="fa fa-thumbs-up" aria-hidden="true"></i>Other Indices</a></li>
							</ul>
                        ...
                        </form><div class="alert alert-heading form invisible" role="alert" id="successmessage" >
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
					...
					<div class="agileits_about_grids w3ls_products_grid">
							...
							<div  id="other" aria-labelledby="other-tab">
										<h3>Other Indices</h3>
								  ...
								  <div class="panel-body panel_text">
										<ul class="list3">
                                           ...
                                           if($check=='deactive')
                                           {
                                            ...
                                            echo site_url('indices/other/'.$this->indice->getSlugByIndxxId($ind['indxx_id'])) ?>" rel="nofollow"><?php echo  $this->indice->getIndexxNameByIndxxId($ind['indxx_id']); ?> </a></li>
                                              <?php } ?>
