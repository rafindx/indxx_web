...
<title>Strategy Indices - Indxx</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="Strategy Indices, Indxx Strategy, Strategy Indexes, Indxx Strategy Indexing, Smart Beta Strategy, Strategy Indexing, Factor Index, Multifactor Index">
<meta name="description" content="Indxx Strategy Indices are designed to effectively target specific asset allocations and capitalize on market opportunities, tactical and trading strategies. We also build smart beta strategies that seek to enhance risk adjusted return, based on one or more performance factors.">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="solution_tabs">
						...
						<ul>
								...
								<li role="presentation" class="active"><a href="<? echo base_url()?>indices/strategy" class="str"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> Strategy Indices</a></li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
					...
					<div class="agileits_about_grids w3ls_products_grid">
							...
							<div id="strategy" aria-labelledby="strategy-tab">
										<h3>Strategy</h3>
										<p>Indxx Strategy Indices are designed to effectively target specific asset allocations and capitalize on market opportunities, tactical and trading strategies.<br/><br/>
                                        We develop sophisticated strategies through a systematic approach involving rigorous analysis to meet the specified return and risk objectives. These rule-based strategies may focus on individual factors or a blend of several factors such as Dividend Yield, Volatility, Momentum, Value, Quality, Growth, and Size. Our capabilities also extend to the development of tailored frameworks/models to realise the desired benefits through efficient asset allocation and diversification.<br/><br/>
                                        We also build smart beta strategies that seek to enhance risk adjusted return, based on one or more performance factors. This may include the utilisation of alternative weighting schemes such as liquidity, quality, value, and momentum. <br/><br/>
                                        Have an idea in mind? Contact us at <a href="mailto:info@indxx.com" >info@indxx.com</a>.
                                        </p>
										...
										<ul class="list3">
                                         <?php 
											...
											?>  
										<li><a href="<?php echo site_url('indices/strategy/'.$strategy->slug) ?>" rel="nofollow"><?php echo $strategy->indxx_name;?></a></li>
