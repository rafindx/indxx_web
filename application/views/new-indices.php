                ...
                <div class="col-md-3 col-sm-12 col-xs-12">
                    <div class="solution_tabs">
						...
						<ul>
								...
								<li role="presentation"><a href="#income" role="tab" id="income-tab" data-toggle="tab" aria-controls="income" class="str"><i class="fa fa-file" aria-hidden="true"></i> Fact Sheet</a></li>
								<li role="presentation"><a href="#alternative" role="tab" id="alternative-tab" data-toggle="tab" aria-controls="alternative" class="str"> <i class="fa fa-sitemap" aria-hidden="true"></i> Methodology</a></li>
								<li role="presentation"><i class="fa fa-thumbs-up" aria-hidden="true"></i><a href="#other" role="tab" id="other-tab" data-toggle="tab" aria-controls="other" class="str">  Index Values</a></li>
							</ul> 
                    </div>
                </div>
											...
											<table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:0px !important;">
												<tbody>
													...
													<tr style="height:30px;background:none repeat scroll 0 0 <?php echo $color;?>;text-align:center">
														...
														<td align="right" style="font-size:14px;padding-right:5px!important;"><?php echo (number_format(((float)$values["weight"])*100,2,'.',''));?>%</td>
													</tr>
												<?php }
													}else{ ?>
